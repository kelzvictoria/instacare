          ...
          <div className={styles.bigScreenSidebar}>
            <div className={styles.optionsGroup}>
              ...
              <Row>
                <Col xs={8} md={24} className={styles.inputLabels}>
                  <Row>
                    <Col md={12}>Adults</Col>
                    <Col md={12} className={styles.peopleBoxes}>
                      <InputNumber
                        min={0}
                        max={1000}
                        defaultValue={this.props.responses.adult}
                        onChange={this.eventHandlers.handleAdult}
                      />
                    </Col>
                  </Row>
                </Col>
                  ...
                  <Row>
                    ...
                    <Col md={12} className={styles.peopleBoxes}>
                      <InputNumber
                        min={0}
                        max={1000}
                        defaultValue={this.props.responses.children}
                        onChange={this.eventHandlers.handleChildren}
                      />
                    </Col>
                  </Row>
                </Col>
                ...
                <Col xs={8} md={24} className={styles.inputLabels}>
                  <Row>
                    <Col md={12}>Infants</Col>
                    <Col md={12}>
                      <InputNumber
                        min={0}
                        max={1000}
                        defaultValue={this.props.responses.children}
                        onChange={this.eventHandlers.handleInfants}
                        name="infants"
                      />
                    </Col>
                  </Row>
            ...
            <div className={styles.optionsGroup}>
              <Collapse defaultActiveKey={["1"]} onChange={this.callb}>
                <Panel header="Basic features" key="1">
                  ...
                  <Checkbox.Group
                    className={styles.smallScreenCheckbox}
                    options={this.basicPlanOptions}
                    value={["malaria", "typhoid", "consultations", "pharmacy"]}
                    style={{
                      display: "grid",
                      gridGap: "5px",
                  ...
                  <Checkbox.Group
                    className={styles.bigScreenCheckbox}
                    options={this.basicPlanOptions}
                    value={["malaria", "typhoid", "consultations", "pharmacy"]}
                    disabled
                  />
              ...
              <Collapse defaultActiveKey={["1"]} onChange={this.callb2}>
                <Panel header="Additional features" key="2">
                  ...
                  <Checkbox.Group
                    ...
                    onChange={this.eventHandlers.handleCheckbox}
            ...
            <div className={styles.optionsGroup}>
              <p className={styles.sideBarHeadings}>
                Total Benefit Limit{" "}
                <span>
                  ({this.minbudgett}, {this.maxbudgett})
                </span>
              </p>
              <Slider
            ...
            <Row>
              <Col xs={24} md={8} className={styles.cardColumn}>
                <Card
                  ...
                  style={{ height: "100%" }}
                  title="Sponsored"
                  headStyle={{ background: "#1A7749", color: "#ffffff" }}
                  onClick={() => {
                    ...
                    <div>
                      <Title level={4}>
                        <Title level={4}>
                          <div style={{ width: "200px" }}>
                            <img
                              className={
                                styles.responsive + " " + styles.planImage2
                              }
                              src={this.props.plans[this.popularIndex].imageUrl}
                            ></img>
                          </div>
                        </Title>
                      </Title>
                      ...
                      >
                        <li>
                          ...
                          >
                            {numeral(
                              this.props.plans[this.popularIndex].price
                            ).format("0,0")}
                          </span>
                        </li>
              ...
              <Col xs={24} md={8} className={styles.cardColumn}>
                <Card
                  ...
                  headStyle={{ background: "#EEEEEE", color: "#00000" }}
                  onClick={() => {
                ...
                >
                  {this.props.cheapestPlan.price > 0 &&
                  !this.props.didRequestReturnEmptyResult ? (
                    <div>
                      <Title level={4}>
                        <div style={{ width: "200px" }}>
                          <img
                            ...
                            src={this.props.cheapestPlan.imageUrl}
                          ></img>
                        </div>
                      </Title>
                      <ul
                      ...
                      >
                        <li>
                          ...
                          >
                            {numeral(this.props.cheapestPlan.price).format(
                              "0,0"
                            )}
                          </span>
                        </li>
              ...
              <Col xs={24} md={8} className={styles.cardColumn}>
                <Card
                  ...
                  style={{ height: "100%" }}
                  headStyle={{ background: "#EEEEEE", color: "#000000" }}
                  onClick={() => {
                    ...
                    <div>
                      <Title level={4}>
                        <div style={{ width: "200px" }}>
                          <img
                            ...
                            src={this.props.mostExpensivePlan.imageUrl}
                          ></img>
                        </div>
                      </Title>
                      <ul
                      ...
                      >
                        <li>
                          ...
                          >
                            {numeral(this.props.mostExpensivePlan.price).format(
                              "0,0"
                            )}
                          </span>
                        </li>
                    ...
                    <Card>
                      <Row>
                        <Col md={6} className={styles.cardProperties}>
                          <img
                            className={
                              styles.responsive + " " + styles.planImage
                            }
                            src={item.imageUrl}
                            alt=""
                          />
